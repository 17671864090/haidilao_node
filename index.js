...
var j = schedule.scheduleJob(rule, function(){
    ...
    axios.get(`http://www.mili18.com:9180/service.asmx/UserLoginStr?name=${username}&psw=${password}`)
        .then(function (response) {
            ...
            // const data = {
            //     YAM_username:931308832,
            //     YAM_password:"ma931308832",
            //     YAM_Token:response.data
            // }
...
//
// var k = new schedule.RecurrenceRule();
// k.second =[0,10,20,30,40,50]
// // rule.minute =30; // rule.second =0;
// var k1 = schedule.scheduleJob(rule, function(){
//     console.log('现在时间：',new Date(),'账号秘钥获取成功');
//     const username = 931308832
//     const password = "ma931308832"
//     axios.get(`http://www.mili18.com:9180/service.asmx/UserLoginStr?name=${username}&psw=${password}`)
...
//     YAM_Token:""
// }
// Token.create(data,function (err,data) {
//     console.log(data)
// })
